...
*>
*  =====================================================================
      SUBROUTINE zsLAE2( A, B, C, RT1, RT2 )
*
...
*
*     .. Scalar Arguments ..
c$$$      DOUBLE PRECISION   A, B, C, RT1, RT2
      complex(8)   A, B, C, RT1, RT2
*     ..
*
* =====================================================================
*
...
*     ..
*     .. Local Scalars ..
c$$$      DOUBLE PRECISION   AB, ACMN, ACMX, ADF, DF, RT, SM, TB
      complex(8)   AB, ACMN, ACMX, ADF, DF, RT, SM, TB
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, SQRT
*     ..
...
*
      ...
      ELSE
         ...
         ACMN = A
      END IF
      IF( dble(ADF).GT.dble(AB) ) THEN
         RT = ADF*SQRT( ONE+( AB / ADF )**2 )
      ELSE IF( dble(ADF).LT.dble(AB) ) THEN
