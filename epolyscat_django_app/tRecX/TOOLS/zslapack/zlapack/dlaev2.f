...
*>
*  =====================================================================
      SUBROUTINE zsLAEV2( A, B, C, RT1, RT2, CS1, SN1 )
*
...
*     .. Scalar Arguments ..
!      DOUBLE PRECISION   A, B, C, CS1, RT1, RT2, SN1
      complex(8)   A, B, C, CS1, RT1, RT2, SN1
*     ..
*
* =====================================================================
*
...
!     $                   TB, TN
      complex(8)   AB, ACMN, ACMX, ACS, ADF, CS, CT, DF, RT, SM,
     $                   TB, TN
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, SQRT
