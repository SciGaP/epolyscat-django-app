...
*
*  =====================================================================
      SUBROUTINE zsLAR2V( N, X, Y, Z, INCX, C, S, INCC )
*
...
*     .. Local Scalars ..
      INTEGER            I, IC, IX
c$$$      DOUBLE PRECISION   CI, SI, T1, T2, T3, T4, T5, T6, XI, YI, ZI
      complex(8)  CI, SI, T1, T2, T3, T4, T5, T6, XI, YI, ZI
*     ..
